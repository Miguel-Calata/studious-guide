...
Para agregar/quitar/cambiar modelos, edita la lista AVAILABLE_MODELS.
Cada entrada tiene:
  - id:    identificador del modelo en OpenRouter
  - label: nombre legible que se muestra en la UI
"""
